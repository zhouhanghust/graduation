...
plt.plot(false_positive_rate_cnn, true_positive_rate_cnn,'r-',label='AUC-cnn = %0.4f'% roc_auc_cnn)
plt.plot(false_positive_rate_rnn, true_positive_rate_rnn,'g-',label='AUC-rnn = %0.4f'% roc_auc_rnn)
plt.plot(false_positive_rate_crnn, true_positive_rate_crnn,'b-',label='AUC-crnn = %0.4f'% roc_auc_crnn)
